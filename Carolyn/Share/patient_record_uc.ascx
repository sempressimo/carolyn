<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="patient_record_uc.ascx.cs" Inherits="Carolyn.Share.patient_record_uc" %>
...
<h3><span class="label label-warning">Contacto de Emergencia</span></h3>
    ...
    <div class="form-group pull-right">
        ...
        <asp:LinkButton ID="lbCancel" CausesValidation="false" runat="server" CssClass="btn btn-default" OnClick="lbCancel_Click">Cancel</asp:LinkButton>
    </div>
